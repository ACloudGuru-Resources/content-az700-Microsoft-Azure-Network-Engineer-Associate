...
az network vnet create --name spoke1-vnet --resource-group $rg --location $location --address-prefixes 10.1.0.0/16 --subnet-name spoke-1-subnet-a --subnet-prefix 10.1.0.0/24 --subnet-name GatewaySubnet --subnet-prefix 10.1.1.0/27
